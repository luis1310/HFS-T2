...
En este capítulo se establecen los fundamentos teóricos necesarios para comprender el problema de optimización abordado, incluyendo conceptos de optimización multiobjetivo, dominancia de Pareto, algoritmos evolutivos y NSGA-II, problemas de Hybrid Flow Shop, y sostenibilidad energética en manufactura. Posteriormente, se contrasta la literatura y se menciona el aporte que se busca dar con el presente proyecto y la diferencia del mismo respecto a otros trabajos previos en el campo de optimización multiobjetivo para programación en líneas de ensamblaje.

\item \textbf{Metodología y Herramientas:} \\
En este capítulo se describe la metodología a utilizar para encontrar la solución a la problemática, lo que implica una descripción de las condiciones del problema y de la función de fitness multiobjetivo a utilizar. También se describe la implementación del algoritmo NSGA-II estándar y su variante memética, así como los operadores de cruce y mutación implementados. Se presenta la metodología de selección de configuración mediante tunning de hiperparámetros y comparación de operadores, considerando criterios como robustez, replicabilidad y calidad de las soluciones. Adicionalmente, se explica cómo se visualiza y analiza el frente de Pareto obtenido. Finalmente, se detalla el estudio de ablación realizado para identificar oportunidades de optimización y las implementaciones de vectorización con NumPy aplicadas para mejorar la eficiencia computacional.

\item \textbf{Resultados y Discusión:} \\
En este capítulo se presentan los resultados obtenidos de los experimentos realizados, comenzando con el tunning multiobjetivo de hiperparámetros y la comparación sistemática de operadores de cruce y mutación. Se analiza la comparación entre la versión estándar del NSGA-II y su variante memética, evaluando tanto la calidad de las soluciones como la eficiencia computacional. Se presentan los resultados del estudio de ablación y el impacto de las optimizaciones de vectorización implementadas. Se discuten las características del frente de Pareto obtenido, incluyendo el análisis de las soluciones representativas y las visualizaciones que facilitan la toma de decisiones. Finalmente, se comparan los resultados con trabajos previos en la literatura.

\item \textbf{Conclusiones y Trabajo Futuro:} \\
En este capítulo se exponen las conclusiones obtenidas del proyecto, incluyendo la efectividad del enfoque multiobjetivo implementado, las contribuciones principales del trabajo y las limitaciones identificadas. Se presentan las recomendaciones para la selección de algoritmos y configuraciones según diferentes criterios de decisión. Finalmente, se proponen direcciones futuras de investigación y posibles extensiones del trabajo.
