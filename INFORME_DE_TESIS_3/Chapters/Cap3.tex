...
El estudio de ablación evalúa 11 variantes diferentes del algoritmo, incluyendo:
\begin{itemize}
    \item Variantes con y sin filtro epsilon de similitud
    \item Variantes con y sin búsqueda local (para la versión memética)
    \item Diferentes combinaciones de operadores genéticos (cruce uniforme vs. one-point, mutación swap vs. insert vs. invert)
    \item Comparación entre NSGA-II estándar y memético con diferentes componentes activados/desactivados
\end{itemize}

Cada variante se ejecuta con 30 semillas independientes para garantizar robustez estadística. Los resultados del estudio de ablación permiten:
\begin{itemize}
