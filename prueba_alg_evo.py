...
inicio = time.time()
mejor_individuo, mejor_fitness, mejor_generacion=algoritmo_evolutivo(poblacion, tamano_poblacion,tiempos_iniciales, incrementos, maquinas_por_etapa, num_generaciones, k, tasa_mutacion)
fin = time.time()
print("\n########################################################\n")
